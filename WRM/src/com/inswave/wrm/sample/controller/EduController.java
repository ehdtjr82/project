...
public class EduController {
	...
	public @ResponseBody Map<String, Object> getMemberInfo(@RequestBody Map<String, Object> param) {
		String empCd = null;
		Map memMap = null;
		List favList = null;
	...
	public @ResponseBody Map<String, Object> e001SelectListAll(@RequestBody Map<String, Object> param) {
		Map sParam = null;
		String daoType = null;
	...
	public @ResponseBody Map<String, Object> e001SearchZipcode(@RequestBody Map<String, Object> param) {
		Map sParam = null;
		String sTown = null;
		boolean isArrayType = false;
		Result result = new Result();
