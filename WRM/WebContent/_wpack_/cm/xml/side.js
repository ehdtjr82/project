...
scwin.initDataCallback = async function () {
  ...
  if (layout == "S") {
    ...
    if ($c.util.isEmpty($p, menuCd)) {
      $c.win.openMenu($p, "메인", "/cm/xml/main.xml", "MAIN", null, option);
    } else {
      const menuInfo = dlt_menu.getMatchedJSON("MENU_CD", menuCd);
      if (menuInfo.length > 0 && !$c.util.isEmpty($p, menuInfo[0].SRC_PATH)) {
        const option = {
          isHistory: true
        };
        return $c.win.openMenu($p, menuInfo[0].MENU_NM, menuInfo[0].SRC_PATH, menuInfo[0].MENU_CD, null, option);
      }
    }
  } else {
    await $c.win.openMenu($p, "메인", "/cm/xml/main.xml", "MAIN", null, option);
    (async function openSideMenu(tabIndex) {
      ...
      if ($c.util.isEmpty($p, menuCd) === false) {
        ...
        if (menuInfo.length > 0 && !$c.util.isEmpty($p, menuInfo[0].SRC_PATH)) {
          ...
          await $c.win.openMenu($p, menuInfo[0].MENU_NM, menuInfo[0].SRC_PATH, menuInfo[0].MENU_CD, null, option);
        }
      }
    })();
  }
...
}}}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload',class:'','ev:onbeforepageunload':'scwin.onbeforepageunload'},E:[{T:1,N:'xf:group',A:{class:'side_tab',id:'',style:''},E:[{T:1,N:'xf:group',A:{id:'',style:'',tagname:'ul',class:''},E:[{T:1,N:'xf:group',A:{class:'on',id:'',style:'',tagname:'li'},E:[{T:1,N:'w2:anchor',A:{class:'','ev:onclick':'scwin.anc_menu_onclick',id:'anc_menu',outerDiv:'false',style:''},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'메뉴'}]}]}]},{T:1,N:'xf:group',A:{id:'grp_favMenu',style:'',tagname:'li'},E:[{T:1,N:'w2:anchor',A:{'ev:onclick':'scwin.anc_menu02_onclick',id:'anc_menu02',outerDiv:'false',style:''},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'즐겨찾기'}]}]}]}]},{T:1,N:'xf:group',A:{id:'gr_shortcut_box',class:'grp_btn',style:''},E:[{T:1,N:'w2:anchor',A:{outerDiv:'false',style:'',id:'btn_allSearch',class:'btn_side_sch','ev:onclick':'scwin.btn_allSearch_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'메뉴검색'}]}]},{T:1,N:'w2:anchor',A:{'ev:onclick':'scwin.btn_menuCollapseAll_onclick',outerDiv:'false',disabled:'',style:'display:none;',id:'btn_menuCollapseAll',class:'btn_side_menufold'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'메뉴접기'}]}]},{T:1,N:'w2:anchor',A:{'ev:onclick':'scwin.btn_menuExpandAll_onclick',outerDiv:'false',style:'',id:'btn_menuExpandAll',class:'btn_side_menufold'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'메뉴펼치기'}]}]}]},{T:1,N:'xf:group',A:{class:'search_field','ev:onblur':'',id:'gr_search_field',style:''},E:[{T:1,N:'w2:autoComplete',A:{allOption:'',caseSensitive:'false',chooseOption:'true',chooseOptionLabel:'메뉴를 검색하세요',chooseOptionValue:'none',class:'w2gridViewItemTable_main',displayMode:'label',editType:'select','ev:onviewchange':'scwin.acb_search_onviewchange',id:'acb_search',interactionMode:'',noResult:'first',ref:'',search:'contain',style:'',submenuSize:'auto',textAlign:'left',useKeywordHighlight:'false'},E:[{T:1,N:'w2:choices',E:[{T:1,N:'w2:itemset',A:{nodeset:'data:dlt_menu'},E:[{T:1,N:'w2:label',A:{ref:'MENU_NM'}},{T:1,N:'w2:value',A:{ref:'MENU_CD'}}]}]}]}]}]},{T:1,N:'xf:group',A:{class:'sidebox',id:'grp_sidebox',style:''},E:[{T:1,N:'xf:group',A:{class:'grp_tab',id:'',style:''},E:[{T:1,N:'xf:group',A:{id:'swh_lnbbox',class:'tab_conbox'},E:[{T:1,N:'xf:group',A:{style:'',id:'gr_tab_menu',class:'tab_con scrollbar'},E:[{T:1,N:'w2:generator',A:{style:'',id:'gen_depth1',class:'side_list depth1',tagname:'ul'},E:[{T:1,N:'xf:group',A:{class:'side_item system',id:'grp_1depth',style:'',tagname:'li','ev:onclick':'scwin.grp_1depth_onclick'},E:[{T:1,N:'w2:anchor',A:{id:'btn_1depth',outerDiv:'false',style:'','ev:onclick':'scwin.second_gen'},E:[{T:1,N:'xf:label'}]},{T:1,N:'w2:generator',A:{id:'gen_2depth',style:'',tagname:'ul'},E:[{T:1,N:'xf:group',A:{'ev:onmouseleave':'scwin.grp_sMenu_onmouseleave','ev:onmouseover':'scwin.grp_sMenu_onmouseover',id:'grp_2depth',style:'',tagname:'li',class:'side_list system'},E:[{T:1,N:'w2:anchor',A:{id:'btn_2depth',outerDiv:'false',style:'','ev:onclick':'scwin.third_gen'},E:[{T:1,N:'xf:label'}]},{T:1,N:'w2:generator',A:{style:'',id:'gen_3depth',tagname:'ul'},E:[{T:1,N:'xf:group',A:{class:'','ev:onmouseleave':'scwin.grp_sMenu_onmouseleave','ev:onmouseover':'scwin.grp_sMenu_onmouseover',id:'grp_3depth',style:'',tagname:'li'},E:[{T:1,N:'w2:anchor',A:{id:'btn_3depth',outerDiv:'false',style:'','ev:onclick':'scwin.menubtn_onclick'},E:[{T:1,N:'xf:label'}]}]}]}]}]}]}]},{T:1,N:'xf:group',A:{class:'side_list depth1',id:'',style:'display: none;',tagname:'ul'},E:[{T:1,N:'xf:group',A:{class:'side_item system',id:'grp_sBox',style:'',tagname:'li'},E:[{T:1,N:'w2:anchor',A:{id:'btn_system',outerDiv:'false',style:''},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'시스템'}]}]},{T:1,N:'w2:generator',A:{style:'',id:'gen_sMenu',tagname:'ul'},E:[{T:1,N:'xf:group',A:{id:'grp_sMenu',style:'','ev:onmouseover':'scwin.grp_sMenu_onmouseover','ev:onmouseleave':'scwin.grp_sMenu_onmouseleave',tagname:'li'},E:[{T:1,N:'w2:anchor',A:{outerDiv:'false',id:'btn_gen',style:'','ev:onclick':'scwin.menubtn_onclick'},E:[{T:1,N:'xf:label'}]}]}]}]},{T:1,N:'xf:group',A:{class:'side_item people',id:'grp_aBox',style:'',tagname:'li'},E:[{T:1,N:'w2:anchor',A:{id:'btn_adm',outerDiv:'false',style:''},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'인사'}]}]},{T:1,N:'w2:generator',A:{id:'gen_aMenu',style:'',tagname:'ul'},E:[{T:1,N:'xf:group',A:{'ev:onmouseleave':'scwin.grp_aMenu_onmouseleave','ev:onmouseover':'scwin.grp_aMenu_onmouseover',id:'grp_aMenu',style:'',tagname:'li'},E:[{T:1,N:'w2:anchor',A:{id:'btn_aGen',outerDiv:'false',style:'','ev:onclick':'scwin.menubtn_onclick'},E:[{T:1,N:'xf:label'}]}]}]}]},{T:1,N:'xf:group',A:{class:'side_item monitor',id:'grp_sample',style:'',tagname:'li'},E:[{T:1,N:'w2:anchor',A:{id:'btn_sample',outerDiv:'false',style:'','ev:onclick':'scwin.btn_sample_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'샘플화면'}]}]}]}]}]},{T:1,N:'xf:group',A:{style:'display: none;',id:'gr_tab_menu02',class:'tab_con scrollbar'},E:[{T:1,N:'w2:generator',A:{style:'',id:'gen_fav',class:'side_fav',tagname:'ul'},E:[{T:1,N:'xf:group',A:{class:'',id:'',style:'',tagname:'li'},E:[{T:1,N:'w2:anchor',A:{id:'btn_fav',outerDiv:'false',style:'','ev:onclick':'scwin.btn_fav_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'메뉴관리'}]}]}]}]}]}]}]}]},{T:1,N:'xf:group',A:{class:'recent_open',id:'box_history',style:''},E:[{T:1,N:'xf:group',A:{id:'',class:'titbox'},E:[{T:1,N:'w2:textbox',A:{style:'',id:'',label:'Open Recent',class:'tit'}},{T:1,N:'xf:group',A:{id:'',class:'rt'},E:[{T:1,N:'xf:trigger',A:{style:'',id:'btn_recent_allclose',type:'button',class:'btn_recent_close','ev:onclick':'scwin.btn_recent_allclose_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'삭제'}]}]}]}]},{T:1,N:'w2:generator',A:{style:'',id:'gen_history',class:'',tagname:'ul'},E:[{T:1,N:'xf:group',A:{style:'',id:'',class:'work_item',tagname:'li'},E:[{T:1,N:'w2:anchor',A:{outerDiv:'false',style:'',id:'btn_History',class:'on','ev:onclick':'scwin.btn_History_onclick'},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'권한관리'}]}]},{T:1,N:'xf:trigger',A:{id:'btn_history_clear',style:'',type:'button','ev:onclick':'scwin.btn_history_clear_onclick',class:''},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'삭제'}]}]}]}]}]},{T:1,N:'xf:group',A:{class:'side_banner',id:'',style:''},E:[{T:1,N:'w2:textbox',A:{class:'banner_tit',id:'',label:'Customer Center',style:''}},{T:1,N:'xf:group',A:{id:'',style:'',tagname:'ul'},E:[{T:1,N:'xf:group',A:{class:'call',id:'',style:'',tagname:'li'},E:[{T:1,N:'w2:textbox',A:{id:'',label:'제품문의',style:''}},{T:1,N:'w2:anchor',A:{id:'',outerDiv:'false',style:''},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'1522-1421'}]}]}]},{T:1,N:'xf:group',A:{id:'',style:'',tagname:'li'},E:[{T:1,N:'w2:textbox',A:{id:'',label:'기술지원 및 교육문의',style:''}},{T:1,N:'w2:anchor',A:{id:'',outerDiv:'false',style:''},E:[{T:1,N:'xf:label',E:[{T:4,cdata:'http://wtech.inswave.kr'}]}]}]}]}]},{T:1,N:'xf:group',A:{id:'',style:'display: none;',class:'hide'}}]}]}]})