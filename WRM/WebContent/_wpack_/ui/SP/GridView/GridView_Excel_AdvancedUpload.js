/*amd /ui/SP/GridView/GridView_Excel_AdvancedUpload.xml 37510 f970cb455b1d1b90931501aec559bc6488ea981c93d04aed0f50473f7c7af837 */
...
scwin.btn_uploadData_onclick = function () {
  ...
  if (type != "csv") {
    ...
    $c.data.uploadGridViewExcel($p, grd_excelGrid, options);
  } else {
    options = dma_csvOptionSetting.getJSON();
    $c.data.uploadGridViewCSV($p, grd_excelGrid, options);
  }
};
...
scwin.sdr_moveEvent = function () {
  ...
  const componentSdrId = $c.util.getComponentv($p, sdrId);
